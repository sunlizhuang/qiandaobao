...
//    InfoArray = [WorkTimeInfoArray read] ;
    [self getcheckinlogs] ;
    NSString * datestring = [NSString stringWithString:[[_InfoArray.WorkTimeArray objectAtIndex:0] objectForKey:@"check_in_time"]] ;
...
- (void)setNavigationbar{
    ...
    UIBarButtonItem * shuaxinbutton = [[UIBarButtonItem alloc]initWithTitle:@"位置" style:nil target:self action:@selector(shuaxin)];
