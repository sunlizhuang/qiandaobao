...
- (void)viewWillAppear:(BOOL)animated{
  ...
  _view1.frame = CGRectMake(0, 0, [[UIScreen mainScreen]bounds].size.width, [[UIScreen mainScreen]bounds].size.height*1.1/5);
    _view2.frame =CGRectMake(0,([[UIScreen mainScreen]bounds].size.height/8)-20, [[UIScreen mainScreen]bounds].size.width*5/4, [[UIScreen mainScreen]bounds].size.height);
